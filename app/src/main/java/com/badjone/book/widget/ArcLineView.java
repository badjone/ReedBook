package com.badjone.book.widget;
...
public class ArcLineView extends View {
    ...
    private int mArcHeight = ConvertUtils.dp2px(50);// 圆弧高度
    ...
    public ArcLineView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ArcLineView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ArcLineView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
